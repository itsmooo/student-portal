...
export default function FacultyDashboard() {
  ...
  const [projects, setProjects] = useState([
    {
      ...
      deadline: "2024-05-15",
      description:
        "Developing a new algorithm for image recognition using deep learning techniques.",
    },
    {
      id: 2,
      ...
      deadline: "2024-04-20",
      description:
        "Creating a comprehensive web application with modern frameworks.",
    },
  ]);
  ...
  const handleProjectAction = (projectId, action) => {
    ...
    setProjects((prev) =>
      prev.map((p) => (p.id === projectId ? { ...p, status: action } : p))
    );
  };
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {new Set(projects.map((p) => p.student)).size}
                </p>
              </div>
